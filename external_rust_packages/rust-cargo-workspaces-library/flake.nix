{
  description = "Nix flake for building the rust-cargo-workspaces-library Rust project using nil's environment.";

  inputs = {
    nixpkgs.url = "github:NixOS/nixpkgs/nixos-24.05";
    flake-utils.url = "github:numtide/flake-utils";
    nil.url = "path:../../"; # Path to the nil flake
    crate-src.url = "path:../../../nixpacks/examples/rust-cargo-workspaces/library"; # Path to the crate source
  };
    ...
    flake-utils.lib.eachDefaultSystem (system:
      ...
      in
      {
        packages.default = pkgs.rustPlatform.buildRustPackage rec {
          pname = "rust-cargo-workspaces-library";
          ...
          meta = with pkgs.lib;
            {
              description = "A Nix flake for the rust-cargo-workspaces-library Rust project";
              homepage = "https://github.com/your-org/rust-cargo-workspaces-library"; # Replace with actual homepage
        ...
        devShells.default = pkgs.mkShell {
          ...
          shellHook = ''
            ...
            echo "Welcome to the rust-cargo-workspaces-library development shell!"
          '';
        };
      }
    );
